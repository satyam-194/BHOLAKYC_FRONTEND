...
const SCRIPT = (fullname, amount, utr) => {
  ...
  return `Mera naam ${nameDisp} hai. Maine COINORA VDASP PVT LTD ko ${amtDisp} rupaye diye hain, jiska transaction reference number ${refDisp} hai. Yeh payment genuine hai aur maine koi fraudulent amount nahi bheja hai. Agar mere payment ki wajah se koi debit freeze, lien ya hold aata hai aur yeh prove hota hai, toh main 24 ghante ke andar equivalent USDT ya INR refund kar dunga. Agar main refund nahi karta, toh yeh video legal purposes ke liye use ki ja sakti hai. Maine apni marzi se USDT purchase kiya hai aur mujhe unknown platforms aur scam activities se bachne ki salah di gayi hai. Agar main apni marzi se USDT kisi aur wallet ya platform par transfer karta hoon aur koi loss hota hai, toh uski poori zimmedari meri hogi.`;
};
